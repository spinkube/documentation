...
First, the [Custom Resource Definition (CRD)](../../glossary/_index.md#custom-resource-definition-crd) and the [Runtime Class]({{< ref "glossary#runtime-class" >}}) for `wasmtime-spin-v2` must be installed.
